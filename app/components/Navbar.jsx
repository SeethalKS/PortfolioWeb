...
setIsscroll(false)
  ...
  return (
    ...
    justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20":""}`}>
        <a href="#top">
            <Image src={isDarkMode ? assets.s_logo_dark : assets.s_logo} className='w-28 cursor-pointer mr-14' alt='' />
        </a>
        ...
        <button onClick={()=> setisdarkMode(prev=> !prev)}>
            ...
            <a className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo 
            dark:border-white/50' href="#contact">Contact
                <Image src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon}
                className='w-3' alt=""/>
            </a>
            <button className='block md:hidden ml-3' onClick={openmenu}> <Image src={isDarkMode ? assets.menu_white :assets.menu_black} alt=""
