            ...
            className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                ...
                className='grid grid-cols-auto my-10 gap-5 dark:text-black'>
                    ...
                    className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group' key={index} style={{backgroundImage: `url(${project.bgImage})`}}>
                        <div className='bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 px-5 flex items-center
                ...
                mx-auto my-20 hover:bg-lightHover duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover' href=''>Show More..
                    <Image className='w-4'src={isDarkmode ? assets.right_arrow_bold_dark: assets.right_arrow_bold} alt='Rightarrow'/>
                </motion.a>
    </motion.div>
  )
}
