...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "8d920b17-965c-41c1-8de3-ba3a575dde9f");
  ...
  return (
    ...
    bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none' id='contact'>
            <motion.h4 
        ...
        className='text-center text-5xl font-Ovo'>
            ...
            className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                ...
                onSubmit={onSubmit} className='max-w-2xl mx-auto'>
                    ...
                    type='submit' className='py-3 px-8 w-max flex items-center 
                    justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>
                        Submit Now <Image className='w-4' src={assets.right_arrow_white} alt="" />
                        </motion.button>
