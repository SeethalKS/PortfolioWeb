  ...
  return (
    ...
    className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
          ...
          <Image src={assets.s_image} alt='user' className='w-full rounded-3xl' />
          </motion.div>
          <motion.div 
           initial={{opacity: 0}} 
           whileInView={{opacity:1}}
...
<p className='mb-10 max-w-2xl font-Ovo'>
  I am an experienced Software Developer with 5yrs of professional expertise in the field. Throughout my career,
...
className='flex items-center gap-3 sm:gap-5'>
  {
    toolsData.map((tool,index)=>(
      ...
      justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500' key={index}>
